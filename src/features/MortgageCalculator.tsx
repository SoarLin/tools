...
export const MortgageCalculator: React.FC = () => {
  ...
  return (
    <Box as="form" onSubmit={handleSubmit}>
      <Grid gap={3}>
        <Box>
          <Label mb={2} sx={{ fontSize: 1, color: 'text', opacity: 0.7 }}>貸款金額</Label>
        ...
        <Box>
          <Label mb={2} sx={{ fontSize: 1, color: 'text', opacity: 0.7 }}>貸款年限</Label>
          <Box sx={{ position: 'relative' }}>
            <Input
              type="number"
              value={years}
              ...
              sx={{ pr: 5, bg: 'muted', borderColor: 'borderColor' }}
            />
            <Text sx={{ position: 'absolute', right: 3, top: '50%', transform: 'translateY(-50%)', fontSize: 1, color: 'text', opacity: 0.5 }}>年</Text>
          </Box>
        </Box>

        <Box>
          <Label mb={2} sx={{ fontSize: 1, color: 'text', opacity: 0.7 }}>貸款利率</Label>
          <Box sx={{ position: 'relative' }}>
            <Input
              type="number"
              value={rate}
              ...
              sx={{ pr: 5, bg: 'muted', borderColor: 'borderColor' }}
            />
            <Text sx={{ position: 'absolute', right: 3, top: '50%', transform: 'translateY(-50%)', fontSize: 1, color: 'text', opacity: 0.5 }}>%</Text>
          </Box>
        </Box>
